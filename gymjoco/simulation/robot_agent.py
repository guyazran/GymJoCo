...
class RobotAgent:
    ...
    public fields:
        ...
        - entity:
            An `Entity` object (see `gymjoco.simulation.entity.Entity`) binding the robot model to the simulation
            physics.
        - sensor_map:
            A dictionary (str --> Sensor) where Sensor is a `gymjoco.simulation.Entity` object representing a sensor
        ...
        - actuators:
            An entity `Entity` object (see `gymjoco.simulation.entity.Entity`) binding the list of actuator elements
    ...
    def observation_space(self) -> gym.core.spaces.Space:
        ...
        # set robot_state observation space
        spaces = dict(
