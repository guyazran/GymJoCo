...
class CfgEpisodeSampler(FiniteRandomEpisodeSampler):
    ...
    - top level keys: The `globals` and `episodes` keys are the top level keys (see `gymjoco.common.defs.cfg_keys`)
    ...
    - internal configurations:  configurations for defining internal components of the episode. see
                                `gymjoco.episode.cfg_parsing.episode_from_cfg` for more details.

    >>> from gymjoco import cfg_keys
    ...
    ...     },
    ...     cfg_keys.TASK: 'gymjoco.tasks:NullTask'
    ... }
    >>> cfg = {
